...
import MedicineAlertManager from './components/MedicineAlertManager'
...
function App() {
    ...
    const { initMedicineListener, cleanupListener: cleanupMedicineListener } = useMedicineStore()
    const { initAppointmentListener, cleanupListener: cleanupAppointmentListener } = useAppointmentStore()
    ...
    // Initialize Firestore listeners when user logs in
    useEffect(() => {
